...
public class Bullets implements ContentList{
    ...
    //electric
    lancerLaser, meltdownLaser, tetherLaser, lightning, arc, damageLightning,
    ...
    public void load(){
		...
		tetherLaser = new BulletType(0.001f, 0){
            Color tmpColor = new Color();
            Color[] colors = {Color.valueOf("5874ec55"), Color.valueOf("5874ecaa"), Color.valueOf("5a9cff"), Color.white};
            float[] tscales = {1f, 0.7f, 0.5f, 0.2f};
            float[] strokes = {0.1f, 0.02f, 0.01f, 0.0025f};
            float length = 500f;
			float tgtlen = 80f;
            float[] lenscales = {tgtlen/1.5f/length, tgtlen/length, tgtlen*1.5f/length, 1.0f};
            ...
            public void update(Bullet b){
                ...
                Effects.shake(0.1f, 0.1f, b.x, b.y);
            }
